        ...
        <div class='collapse navbar-collapse' id='navbarSupportedContent'>
            <ul class='navbar-nav mr-auto'>
                ...
                <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='../other/index.php' id='navbarDropdown' role='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                        Other projects
                    </a>
                ...
                <li class='nav-item'>
                    <a class='nav-link disabled active' href='#' tabindex='-1' aria-disabled='true'>Secret</a>
                </li>
            </ul>
